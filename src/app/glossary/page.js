    ...
    return (
        <>
            <section className="bg-forest-green text-white py-16 md:py-20 text-center rounded-bl-[80px]">
                <h1 className="text-4xl md:text-5xl font-extrabold mb-4 animated-element animate-fade-in-up">Glossary of Digital Terms</h1>
                <p className="text-lg md:text-xl max-w-2xl mx-auto animated-element animate-fade-in-up delay-200">Understand the key concepts in web development, digital marketing, and more.</p>
            </section>
            <section className="py-16 md:py-24 bg-white">
                <div className="container mx-auto px-4 max-w-4xl">
                    <div className="space-y-8">
                        <div className="bg-gray-50 p-6 rounded-lg shadow-md animated-element animate-fade-in-up delay-100">
                            <h3 className="text-2xl font-semibold text-forest-green mb-2">SEO (Search Engine Optimization)</h3>
