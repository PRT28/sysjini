...
export const metadata = {
  title: "About Us - Sysjini | Expert Digital Solutions Team",
        ...
        <div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="order-1 lg:order-2 flex justify-center items-center">
                            <div className="relative">
                                ...
                                <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-forest-200 rounded-full opacity-60"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-20 md:py-32 bg-gradient-to-br from-emerald-50 to-forest-50 relative overflow-hidden">
                ...
                <div className="absolute top-0 left-0 w-full h-full">
                    <div className="absolute top-20 right-20 w-64 h-64 bg-emerald-200 rounded-full mix-blend-multiply filter blur-xl opacity-30"></div>
                    <div className="absolute bottom-20 left-20 w-64 h-64 bg-forest-200 rounded-full mix-blend-multiply filter blur-xl opacity-30"></div>
                </div>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {/* Value 1 */}
                        <div className="modern-card hover-lift p-8 rounded-2xl text-center">
