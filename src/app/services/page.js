            ...
            <section className="py-16 md:py-24 bg-gray-50">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div className="bg-white rounded-lg p-8 shadow-lg card-shadow transform hover:scale-105 transition duration-300 hover-darken animated-element animate-scale-in delay-100">
                        ...
                        <div className="bg-white rounded-lg p-8 shadow-lg card-shadow transform hover:scale-105 transition duration-300 hover-darken animated-element animate-scale-in delay-200">
                            <div className="text-center mb-6">
                                <svg className="w-16 h-16 mx-auto text-forest-green" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="bg-white rounded-lg p-8 shadow-lg card-shadow transform hover:scale-105 transition duration-300 hover-darken animated-element animate-scale-in delay-300">
                            <div className="text-center mb-6">
                                <svg className="w-16 h-16 mx-auto text-forest-green" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="bg-white rounded-lg p-8 shadow-lg card-shadow transform hover:scale-105 transition duration-300 hover-darken animated-element animate-scale-in delay-400">
                            <div className="text-center mb-6">
                                <svg className="w-16 h-16 mx-auto text-forest-green" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="bg-white rounded-lg p-8 shadow-lg card-shadow transform hover:scale-105 transition duration-300 hover-darken animated-element animate-scale-in delay-500">
                            <div className="text-center mb-6">
                                <svg className="w-16 h-16 mx-auto text-forest-green" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="bg-white rounded-lg p-8 shadow-lg card-shadow transform hover:scale-105 transition duration-300 hover-darken animated-element animate-scale-in delay-600">
                            <div className="text-center mb-6">
                                <svg className="w-16 h-16 mx-auto text-forest-green" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
