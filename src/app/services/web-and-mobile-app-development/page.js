        ...
        <>
            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
                ...
                <div className="container mx-auto px-4 text-center relative z-10">
                    <div className="max-w-5xl mx-auto">
                        <div className="w-20 h-20 mx-auto mb-8 bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-2xl flex items-center justify-center shadow-green">
            ...
            <section className="py-20 md:py-32 bg-gradient-to-br from-gray-50 to-emerald-50 relative">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div className="modern-card hover-lift p-8 rounded-2xl group">
            ...
            <section className="py-20 md:py-32 relative">
                <div className="container mx-auto px-4">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 mb-12">
                        <span className="bg-gradient-to-r from-emerald-100 to-emerald-200 text-emerald-800 px-6 py-3 rounded-full shadow-sm hover:shadow-md transition-shadow duration-300 ">Healthcare</span>
                        <span className="bg-gradient-to-r from-forest-100 to-forest-200 text-forest-800 px-6 py-3 rounded-full shadow-sm hover:shadow-md transition-shadow duration-300 ">Fintech</span>
                        <span className="bg-gradient-to-r from-sage-100 to-sage-200 text-sage-800 px-6 py-3 rounded-full shadow-sm hover:shadow-md transition-shadow duration-300 ">E-commerce</span>
                        <span className="bg-gradient-to-r from-mint-100 to-mint-200 text-mint-800 px-6 py-3 rounded-full shadow-sm hover:shadow-md transition-shadow duration-300 ">Education</span>
                        <span className="bg-gradient-to-r from-emerald-100 to-forest-200 text-emerald-800 px-6 py-3 rounded-full shadow-sm hover:shadow-md transition-shadow duration-300 ">Real Estate</span>
                        <span className="bg-gradient-to-r from-forest-100 to-sage-200 text-forest-800 px-6 py-3 rounded-full shadow-sm hover:shadow-md transition-shadow duration-300 ">Logistics</span>
                        <span className="bg-gradient-to-r from-sage-100 to-mint-200 text-sage-800 px-6 py-3 rounded-full shadow-sm hover:shadow-md transition-shadow duration-300 ">Entertainment</span>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 text-center relative z-10">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                            ...
                            <a href="tel:+917017197678" className="border-2 border-white text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-white hover:text-emerald-600 transition-all duration-300 transform hover:scale-105">
                                Call: +91 7017197678
                            </a>
                        </div>
